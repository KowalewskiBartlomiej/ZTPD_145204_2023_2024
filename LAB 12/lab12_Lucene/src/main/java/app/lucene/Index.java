...
public class Index {
    ...
    //Indeks Lucene zawiera pliki z rozszerzeniami: cfe, cfs, si

    //Kolejne wywołanie programu Index bez usunięcia poprzedniego indeksu powoduje jego powielenie (powstają kolejne pliki cfe, cfs i si z kolejną cyfrą) i w efekcie powielenie wyników dla zapytań.
